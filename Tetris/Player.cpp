...
bool Player::isXSumEqual(Point* dest) {
	int sumCurr = 0;
	int sumDest = 0;
	for (int i = 0; i < 4; i++) {
...
int Player::sumOfXcoords(const Point* p) {
	int sum = 0;
	for (int i = 0; i < 4; i++) {
		sum += p[i].getX();
	}
...
int Player::sumOfYcoordsByIndex(int index) {
	int sum = 0;
	for (int i = 0; i < 4; i++) {
...
int Player::sumOfYcoords(const Point* p) {
	int sum = 0;
	for (int i = 0; i < 4; i++) {
		sum += p[i].getY();
	}
...
void Player::setDestsPerRotation() {
	logSize = 0;
